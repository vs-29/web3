      ...
      <div className="flex w-full justify-center items-center">
        <div className="flex md:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
           <div className="flex flex-1 justify-start flex-col md:mr-10">
            ...
            { !currentAccount && (
            <button type="button" onClick={connectWallet} className=" flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]">
            ...
            <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
                ...
                <div className="h-[1px] w-full bg-gray-400 my-2" >
                    { isLoading ? (
                        ...
                        <button type="button" onClick={handleSubmit} className="text-white w-full mt-5 border-[1px] p-2 border-[#3d4f7c] hover:bg-[#3d4f7c] rounded-full cursor-pointer" >
                            Send Now
                        </button>
                    )}
                </div>
